...
variable "network_interfaces" {
  ...
  Options:
      ...
      - elb_ip        : (Optional | string | default:"") If this interface connects to an external load balancer (ELB), specify the IP of the existing ELB here.
          Cloud Function will use this information to configure the FortiGate interface properly.
...
variable "cloud_function" {
  ...
  description = <<-EOF
    ...
    Options:
        ...
        - vpc_network : (Required unless fmg_integration.ums is specified | string) Name of the VPC network the Cloud Function connects to.
